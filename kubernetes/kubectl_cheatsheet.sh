...
$ kubectl run kubernetes-bootcamp --image=gcr.io/google-samples/kubernetes-bootcamp:v1 --port=8080 # Start a sample instance/deployment from gcr.io By Bruce Lu. 2018-03-23 11:07:53
...
$ kubectl scale deployment/kubernetes-bootcamp --replicas=3         # Scale a deployment to 3. Added by Bruce Lu. 2018-03-23 11:10:09
...
$ kubectl exec my-pod --stdin --tty -c my-container /bin/sh # Run bash in existing container of existing pod. Added by Bruce Lu. 2018-03-23 09:26:13
$ kubectl exec -it my-pod bash                        # Run bash in existing pod. Added by Bruce Lu. 2018-03-23 09:20:51
$ kubectl exec -it my-pod env                         # Display environment variables. Added by Bruce Lu. 2018-03-23 09:19:50
